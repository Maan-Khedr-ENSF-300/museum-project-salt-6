...
(
    ...
    Primary Key(Epoch, Country_of_origin)
);
Create TABLE Art_Object (
	...
	PRIMARY KEY (Unique_id_no, Epoch, Country_of_origin)
);
...
(
   ...
   Constraint FK_unqiue Foreign key(unique_id_no) references Art_Object(unique_id_no)
);

Alter Table Permanent_Collection
Add constraint FK_unique foreign key (unique_id_no) references Art_Object(unique_id_no);
...
(
    ...
    Primary key(unique_id_no),
    Constraint Foreign key(unique_id_no) references Art_Object(unique_id_no)
);
...
('Benedetto da Rovezzano', '1474', '1552', 'Rome', 'Nothern Renaissance', 'Roman sculptures', 'an Italian architect and sculptor who worked mainly in Florence'),
('N/A', 'N/A','N/A', 'Great Britain', 'Early Renaissance', 'Neo-Classical', 'N/A'),
('N/A', 'N/A', 'N/A', 'Florence', 'Renaissance', 'Neo-Classical', 'N/A'),
('N/A', 'N/A', 'N/A', 'Venice', 'Middle Renaissance', 'Roman-Catholic', 'N/A');
...
insert into Permanent_Collection(unique_id_no, date_acquired, status, cost)
...
INSERT into Painting(unique_id_no, Drawn_on, Style, Paint_type)
VALUES (218349039, 'Panel', 'Northern renaissance', 'Oil'),
(237892120, 'Panel', 'Nothern Renaissance', 'Oil'),
(255980678, 'Canvas', 'Northern renaissance', 'Oil'),
(234093894, 'Panel', 'Nothern renaissance', 'Oil')
;

INSERT into Sculpture 
VALUES (20, 14.625, 'Roman Scultpure', 'Bronze', 355611559),
(310, 39.75, 'Roman Sculpture', 'Bronze', 321098735);
...
INSERT into Statue
VALUES (219437824, 20.5, 71, 'Terracotta', 'Roman Sculpture'),
(290124789, 18.875, 62, 'Terracotta', 'Renaisance sculpture');
